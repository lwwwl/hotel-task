...
COMMENT ON COLUMN hotel_guests.room_name IS '房间号';
...
COMMENT ON COLUMN hotel_guests.chatwoot_conversation_id IS 'chatwoot关联的会话id';
COMMENT ON COLUMN hotel_guests.create_time IS '创建时间';
COMMENT ON COLUMN hotel_guests.update_time IS '更新时间';

CREATE INDEX idx_hotel_guests_room_name ON hotel_guests (room_name);
